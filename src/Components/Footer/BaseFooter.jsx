...
const BaseFooter = () => {
    return (
        <>
            ...
            <FooterInfoContainer>
                <p>주식회사 더 굿즈 | 경기도 용인시 기흥구 덕영대로 1732 | 대표 : 김예빈 | 개인정보보호책임 : 김예빈</p>
                <p>통신판매업신고 : 2024-서울서초-0000  사업자등록번호 : 000-00-00000 | 대표번호 : 010-0000-0000 | cs@thegoods.com</p>
                <p>평일 9:00 ~ 18:00 점심시간 12:00 ~ 13:00 (주말/공휴일 휴무)</p>
            </FooterInfoContainer>
            <FooterInfoContainer>
                <p>더굿즈는 통신판매중개자이며 통신판매의 당사자가 아닙니다.</p>
                <p>개별 판매자가 등록하여 판매한 모든 상품에 대한 거래 정보 및 거래에 대한 책임은 각 판매자가 부담하고, 이에 대하여 더굿즈는 일체 책임지지 않습니다.</p>
