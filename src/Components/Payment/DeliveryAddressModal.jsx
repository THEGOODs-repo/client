...
const DeliveryAddressModal = ({
  ...
  ChangedName,
  ChangedAddress,
  ChangedDetailAddress,
  ChangedZipCode,
  ChangedPhone,
  ChangedDeliveryMemo,
  ChangedDeliveryAddressNickName,
}) => {
  ...
  const HandleChangeAddress = () => {
    ...
    ChangedDetailAddress(DetailAddress);
    ChangedZipCode(ZipCode);
    ChangedPhone(Cell);
    ChangedDeliveryMemo(DeliveryMemo);
    ChangedDeliveryAddressNickName(AddressNickName);
    SaveAsDefaultAddress && fetchAddress();
    onClose();
  };
