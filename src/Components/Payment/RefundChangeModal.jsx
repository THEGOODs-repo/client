...
const RefundChangeModal = ({
  isOpen,
  onClose,
  ChangedRefundAccountHolder,
  ChangedRefundAccount,
  ChangedRefundBank,
}) => {
  ...
  const HandleChangeRefund = () => {
    ChangedRefundAccountHolder(AccountHolder);
    ChangedRefundAccount(RefundAccount);
    ChangedRefundBank(RefundBank);
    SaveAsDefaultRefundAccount && fetchRefund();
    onClose();
  };
