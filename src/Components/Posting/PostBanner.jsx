...
const PostBanner = () =>{
    ...
    const buttonStyle1 = {
        ...
        left: '29%',
        top: '15vw',
        background: followButtonClicked ? 'linear-gradient(90deg, #7474BF 0%, #348AC7 100%)' : '#F9F9F9', // 클릭된 상태에 따라 배경색 변경
    ...
    <div>
        ...
        <div>
            <Link to="../pages/Post" >
                ...
                <span style={{ marginRight: '1vw', width: '2vw', position: 'absolute', left: '2vw', top: '50%', transform: 'translateY(-50%)' }}>
                    <img src={followButtonClicked ? btnimg2 : btnimg1} alt="Follow button" style={{ width: '100%' }} /> {/* 이미지 크기를 조정 */}
                </span>
                <span style={{ paddingLeft: '3vw', paddingRight: '1vw' }}>
                    <span style={buttonTextStyle}>{followButtonClicked ? '인기 포스트 보기' : '팔로우하는 작가 모아보기'}</span> {/* 텍스트 변경 */}
                </span>
                </button>
            </Link>
