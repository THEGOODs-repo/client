...
export default function PreferenceModal() {
  ...
  return (
    <MainContainer style={{ display: modalOpen ? "flex" : "none" }}>
      <ModalContainer>
        ...
        >
          <div style={{ flexDirection: "column" }}>
            <IconContainer
              onClick={() => handleClick(setClick("preference/Create"))}
            >
          ...
          <div style={{ flexDirection: "column" }}>
            <IconContainer
              onClick={() => handleClick(setClick("preference/Idol"))}
            >
          ...
          <div style={{ flexDirection: "column" }}>
            <IconContainer
              onClick={() => handleClick(setClick("preference/Ani"))}
            >
              <img src={Ani} alt="애니" />
            </IconContainer>
            <h6>애니</h6>
          ...
          <div style={{ flexDirection: "column" }}>
            <IconContainer
              onClick={() => handleClick(setClick("preference/Mungu"))}
            >
              <img
                src={Mungu}
                alt="문구"
          ...
          <div style={{ flexDirection: "column" }}>
            <IconContainer
              onClick={() => handleClick(setClick("preference/Food"))}
            >
              <img src={Food} alt="식품" />
            </IconContainer>
            <h6>식품</h6>
          ...
          <div style={{ flexDirection: "column" }}>
            <IconContainer
              onClick={() => handleClick(setClick("preference/Fashion"))}
            >
              <img
                src={Fashion}
                alt="패션"
