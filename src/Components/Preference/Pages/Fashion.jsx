...
export default function PreferenceFashion() {
  ...
  return (
    <PreferenceContainer>
      <h1>패션</h1>
      <h2>
        상품으로는 가방, 자켓, 지갑 등이 있습니다. 패션 카테고리는 패션의 다양한
        상품들을 모두 모아둔 곳입니다. 패션은 니트, 가죽자켓, 청바지와 같은
        다양한 상품들이 있습니다. 상품으로는 가방, 자켓, 지갑 등이 있습니다.
        패션 카테고리는 패션의 다양한 상품들을 모두 모아둔 곳입니다. 패션은
        니트, 가죽자켓, 청바지와 같은 다양한 상품들이 있습니다.
      </h2>
