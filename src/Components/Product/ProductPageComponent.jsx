                    ...
                    <>
                        ...
                        <ProductInnerContainer>
                            <SlideMainImageContainer>
                                <SlideItem src={productInfo['itemImgUrlList'][0]['itemImgUrl']} alt="" />
                            </SlideMainImageContainer>
                            {/* 여기에 기능 만들어야함 */}
                            <ImageSlider
                        ...
                        <ProductInnerContainer>
                            {/* 프로필 */}
                            <ProfileContainer>
                                <ProfileImage src={productInfo.memberProfileImgUrl} alt="" />
                            ...
                            <ProductSideInfoWrapContainer>
                                <div>
                                    <p style={{ fontFamily: "'NotoSans', sans-serif", fontWeight: 'medium', fontSize: '20px' }}>{productInfo.name}</p>
                                </div>
                                <SubInfoContainer>
                                    {/* 가격 */}
                                    <div>
                                        <p style={{ fontFamily: "'NotoSans', sans-serif", fontWeight: 'bold', fontSize: '20px' }}>{productInfo.price}\</p>
                                    </div>
                                    <IconWrapContainer>
                                        {/* 조회수 */}
                                        <IconContainer>
                                            <img src={viewer} alt="" width="32px" height="32px" />
                                            <p style={{ fontSize: '15px', textAlign: 'center' }}>{productInfo.viewCount}</p>
                                        </IconContainer>
                                        {/* 하트 */}
                                        <IconContainer>
