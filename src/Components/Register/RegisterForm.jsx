  ...
  return (
    <RegisterWrapper>
      ...
      <ErrorModal
        ...
        onClose={() => SetDisplayDuplicatedNickname(!DisplayDuplicatedNickname)}
      />
      ...
      <FormWrapper>
        ...
        <div style={{ display: "flex", flexDirection: "row" }}>
          ...
          <DuplicateCheckButton
            onClick={ValidEmail && Email !== "" ? HandleDuplicateEmail : null}
        ...
        <div style={{ display: "flex", flexDirection: "row" }}>
          ...
          <DuplicateCheckButton
            onClick={
              ValidNickname && Nickname !== "" ? HandleDuplicateNickname : null
            }
