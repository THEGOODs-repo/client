    ...
    <>
      <Form>
        ...
        {hasOptions ? (
          ...
          <>
            <NoOptionProductForm>
              ...
              <PriceText>
                <Text>{firstItemPrice.toLocaleString()}원</Text>
              </PriceText>
              <AmountText>
                <Text>{firstItemAmount}개</Text>
              </AmountText>
              <ModifyOrder2 onClick={handleModifyOrderClick}>
                주문수정
              </ModifyOrder2>
              {isModalOpen && (
                <OrderModificationModal
          ...
          cartOptionViewDTOList.map(
            (option, idx) =>
              ...
              option.optionName !== null && (
                <OptionForm key={idx}>
                  <OptionText>
                    선택 {idx + 1} : {option.optionName} /{" "}
                    {option.price.toLocaleString()}원 ({option.amount}개)
                  </OptionText>
                </OptionForm>
              ),
          )}
        ...
        <div style={{ display: "flex" }}>
          ...
          <MarketPriceBox>
            <MarketPrice1>
              주문금액 <MarketPrice>{formattedTotalPrice}원</MarketPrice>
            </MarketPrice1>
